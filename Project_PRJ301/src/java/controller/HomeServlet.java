...
public class HomeServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Product> listS = dao.listProductBySold();
        List<Product> listP = dao.listProductByPrice();
        List<Product> list1 = dao.listProductBySold2();
        List<Product> listL = dao.listProductLast();
