...
public class StatisticalServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int count1 = dao.countAccount1();
        int count2 = dao.countAccount2();
        int totalS = dao.TotalSold();
        int totalP = dao.TotalPrice();
        int avaP = dao.AveragePrice();
        Product p = dao.getMax();
        Product pm = dao.getMin();
        Account a= dao.getUserMax();
        ...
        request.setAttribute("avaP", avaP);
