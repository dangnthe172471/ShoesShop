    ...
    <body>
        ...
        <table>                                                 
            <tbody>
                        ...
                        <ul class="main-menu">
                            <li style="margin-left: 950px;margin-top: -25px;"> <i class="icon fa fa-bars" style="color: black"></i>
                                <ul class="sub-menu" style="background: cornsilk">
                                    <li><a href="#" onclick="editFeedback(event)" class="editbtn" style="color: black"><i class="fa fa-pencil" style="color: springgreen"></i> Edit</a></li>
                                </ul>
                            </li>   
                        </ul>
                    </td>
                ...
                <tr>
                    <td >3 asd asd asd as asd</td>
                    <td >3 asd as sa sa as as das </td>
                    <td >3 a dsa as das das asd a</td> 
                    <td>
                        <ul class="main-menu">
                            <li style="margin-left: 950px;margin-top: -25px;"> <i class="icon fa fa-bars" style="color: black"></i>
                                <ul class="sub-menu" style="background: cornsilk">
                ...
                <tr>
                    <td >2 asd asd asd as asd</td>
                    <td >2 asd as sa sa as as das </td>
                    <td >2 a dsa as das das asd a</td> 
                    <td>
                        <ul class="main-menu">
                            <li style="margin-left: 950px;margin-top: -25px;"> <i class="icon fa fa-bars" style="color: black"></i>
                                <ul class="sub-menu" style="background: cornsilk">
