...
<html>
    ...
    <body>
        ...
        <div class="container">             
            <form action="login" method="post" style="width: 40%;margin: 50px auto; border: 1px solid aqua;padding: 30px; background-color:#ffffff4d">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="Password" name="pass" value="${cookie.cpass.value}">
                </div>
                ...
                <hr>
                <a href="register"><button class="btn btn-primary btn-block" type="button" id="btn-signup"><i class="fas fa-user-plus"></i> Register New Account</button></a>
            </form>            
        </div>
